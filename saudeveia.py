...
st.markdown("""
    ...
    /* Força colunas de métricas a ficarem lado a lado no mobile */
    [data-testid="column"] {
        flex: 1 1 30% !important;
        min-width: 30% !important;
    }
    
    /* Estilização das métricas para ficarem menores */
    [data-testid="stMetricValue"] { font-size: 1.2rem !important; }
    [data-testid="stMetricLabel"] { font-size: 0.8rem !important; }
    
    /* Ajuste de cards e avisos */
    ...
    if not df.empty:
        ...
        for _, r in df.iterrows():
            ...
            with st.container(border=True):
                ...
                # Colunas compactas que não quebram no celular
